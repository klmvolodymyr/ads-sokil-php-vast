...
abstract class AbstractAdNode extends AbstractNode
{
     ...
     * @return $this
     */
    public function addAdWeight($weight)
    {
        // get container
        if (!$this->extensionsDomElement) {
            // get extensions tag
        ...
        $addWeightDomElement = $extensionDomElement->ownerDocument->createElement('AdWeight');
        $extensionDomElement->appendChild($addWeightDomElement);

        $addWeightDomElement->textContent = $weight;
     ...
     * @return $this
     */
    public function addCTA($parameters)
    {
        ...
        $CTADomElement = $extensionDomElement->ownerDocument->createElement('CTA');
